...
Your docs/ folder will need these six images:

pipeline_architecture.png
data_sources_flow.png
annotated_receipt.png
raw_reference_schema.png
raw_transaction_schema.png
raw_weather_schema.png

The three schema images are the ones still to build in Canva. Everything else you already have.you can change the path to doc and send me back the readme : ELT-Pipeline/docs02:58markdown# Restaurant Forecasting — From ELT to Dashboard
...
Your ELT-Pipeline/docs/ folder needs these six files:
...
raw_transaction_schema.png
raw_weather_schema.png
its not working thast the full path exemple : ELT-Pipeline/docs/annotated_receipt.png why?03:02The issue is that README.md image paths are relative to where the README.md file sits in the repo, not absolute paths.
So it depends on where your README.md lives:
If README.md is at the root of the repo:
README.md
ELT-Pipeline/
  docs/
    annotated_receipt.png
Then ELT-Pipeline/docs/annotated_receipt.png should work.
If README.md is inside the ELT-Pipeline folder:
ELT-Pipeline/
  README.md
  docs/
    annotated_receipt.png
Then the path should just be docs/annotated_receipt.png
Most likely issue — the image file isn't pushed to GitHub yet, or the filename case doesn't match exactly (GitHub paths are case sensitive — Annotated_Receipt.png ≠ annotated_receipt.png).
Can you tell me where exactly your README.md sits in the repo folder structure?the readme is inside the ELT-Pipeline/readme.md03:02Then change all image paths to just docs/ — here's the corrected README ready to copy paste:
markdown# Restaurant Forecasting — From ELT to Dashboard
